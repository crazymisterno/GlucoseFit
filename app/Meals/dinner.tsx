...
export default function DinnerView(visible: boolean, updater: (e: boolean) => void) {
    return (
        <Modal
      animationType="slide"
      ...
      <SafeAreaProvider>
        <SafeAreaView>
            <View style={styles.bar}>
                ...
                <Text style={[styles.text, {fontSize: 24, paddingLeft: PixelRatio.getPixelSizeForLayoutSize(12), paddingRight: PixelRatio.getPixelSizeForLayoutSize(12)}]}>
                Dinner
                </Text>
                <Pressable>
                    <Text style={[styles.text, {fontSize: 24}]}>+</Text>
