...
export default function LunchView(visible: boolean, updater: (e: boolean) => void) {
    return (
        <Modal
      animationType="slide"
      ...
      <SafeAreaProvider>
        <SafeAreaView>
            <View style={styles.bar}>
                ...
                <Text style={[styles.text, {fontSize: 24, paddingLeft: PixelRatio.getPixelSizeForLayoutSize(12), paddingRight: PixelRatio.getPixelSizeForLayoutSize(12)}]}>Lunch</Text>
                <Pressable>
                    <Text style={[styles.text, {fontSize: 24}]}>+</Text>
                </Pressable>
            </View>
